...
**Проблема:** `tests/integration/` частично заполнен (dictionary pipeline ✅). Существующие 590 unit-тест проверяют каждый
...
**Файлы:**
- `tests/fixtures/schemas/v070_minimal.json` ✅ — схема V070, 26 leaf полей
- `tests/fixtures/schemas/v072_minimal.json` ✅ — схема V072, 28 leaf полей

✅ Завершено (29.05.2026), коммит 2b88645. 26 leaf полей v070, 28 leaf полей v072, 49 тестов.
...
| TD-10 | **Нет тестовых фикстур** | ✅ TD-10.1 завершён. Осталось: TD-10.2 (справочники), TD-10.3 (conftest.py) |
...
└── fixtures/                🔴 TD-10 (TD-10.1..TD-10.3)
    ...
    │   ├── V070Call1Rq.json                      ❌ Удалён (заменён на v070_minimal.json)
    │   └── V072Call1Rq.json                      ❌ Удалён (заменён на v072_minimal.json)
    ├── dictionaries/
