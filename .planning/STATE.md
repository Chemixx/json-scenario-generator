...
|-----------|-----------|-----------|
| **JsonActualizer** | P0 | Актуализацию JSON по diff |
...
|---|----------|-------|---------|
| 1 | **Wrong JSON Schema Draft** | `src/utils/json_utils.py:11, 165` | Draft7 вместо Draft 2019-09 |
...
|---|--------|--------|-------------|
| 5 | ValueGenerator (с кэшированием UUID) | 2 дня | — |
| 6 | JsonActualizer | 3 дня | ValueGenerator |
...
| **JSON Schema** | Draft 2019-09 (сейчас костыль Draft7) |
